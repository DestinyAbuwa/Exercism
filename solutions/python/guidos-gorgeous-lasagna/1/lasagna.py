...
def preparation_time_in_minutes(number_of_layers):
    ...
    :return: int - prep time (in minutes) derived from 'PREPARATION_TIME_PER_LAYER'
    and number_of_layers.

    Function that takes the number of layers of the lasagna as an argument
    and returns how many minutes needed to prep the lasagna
