...
def compile_ingredients(dishes):
    ...
    for ingredients in dishes:
        master_list = master_list.union(ingredients)
...
def singleton_ingredients(dishes, intersection):
    ...
    # Use symmetric difference to find unique items across all sets
    for dish_set in dishes:
        singletons = singletons.symmetric_difference(dish_set)
        
    # Subtract the intersection to remove items that appear 
    # in 3 or more dishes (which the ^ operator might include)
